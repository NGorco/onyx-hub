...
import { OnyxPluginConfig } from '/Users/lizinga/Documents/coding/onyx-hub/src/application/user_config';
...
const handlers: Record<
  ...
  (
    ...
    pluginConfigs: Map<string, OnyxPluginConfig>,
  ) => Promise<any>
> = {
  get_repos: async (data, pluginConfigs) => {
    ...
    const url = new URL(
      `https://api.github.com/orgs/${config.onyx_data.secrets_from_env.org_id}/repos`,
    );
